                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="first_name" value="{{ $use->first_name }}"
                                                                        placeholder="Enter First Name" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Last Name</label>
                                                                    <input type="text" class="form-control"
                                                                        name="last_name" value="{{ $use->last_name }}"
                                                                        placeholder="Enter Last Name" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Mobile Number</label>
                                                                    <input type="text" class="form-control"
                                                                        name="mobile" value="{{ $use->mobile }}"
                                                                ...
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <div class="icheck-success d-inline col-sm-3">
                                                                        <input type="radio" name="sex" value="1"
                                                                            <?php if($use->gender == 1){ ?> checked <?php } ?>
                                                                            id="radioSuccess1">
                                                                        <label for="radioSuccess1">Male</label>
                                                                    </div>
                                                                    <div class="icheck-success d-inline col-sm-3">
                                                                        <input type="radio" name="sex" value="0"
                                                                            <?php if($use->gender == 0){ ?> checked <?php } ?>
                                                                            id="radioSuccess2">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Address</label>
                                                                    <textarea type="text" rows="5" class="form-control" name="address" placeholder="Enter Address">{{ $use->address }}</textarea>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" class="form-control"
                                                                        name="email" value="{{ $use->email }}"
                                                                        placeholder="Enter Email Address">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>New Password</label>
                                                                    <input type="password" minlength="6"
                                                                        id="txtNewPassword" class="form-control"
